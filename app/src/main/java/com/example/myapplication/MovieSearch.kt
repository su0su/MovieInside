...
open class MovieSearch : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_sr = findViewById(R.id.button_sr)                  //음성인식 버튼
        button_sad = findViewById(R.id.button_sad)                //아쉬워요 버튼
        button_good = findViewById(R.id.button_good)              //재밌어요 버튼
        button_seen = findViewById(R.id.button_seen)              //봤어요 버튼
        button_zzim = findViewById(R.id.button_zzim)              //찜하기 버튼
        button_netflex = findViewById(R.id.button_netflex)        //넷플릭스 버튼
        button_watcha = findViewById(R.id.button_watcha)          //왓챠 버튼
        button_youtube = findViewById(R.id.button_youtube)        //유튜브 버튼
        ...
        textview6=findViewById(R.id.textView6)                    //지금보러갈까 textView
